...
namespace Faithful
{
    internal class DrownedVisage : ItemBase
    {
        ...
        public DrownedVisage(Toolbox _toolbox) : base(_toolbox)
        {
            ...
            drownedVisageItem = Items.AddItem("DROWNED_VISAGE", "Drowned Visage", [ItemTag.Utility, ItemTag.AIBlacklist, ItemTag.HoldoutZoneRelated], "texdrownedvisageicon", "drownedvisagemesh", ItemTier.VoidTier2, _simulacrumBanned: true, _corruptToken: "FAITHFUL_SPACIOUS_UMBRELLA_NAME", _displaySettings: displaySettings);
        ...
        private void CreateDisplaySettings(string _displayMeshName)
        {
            ...
            displaySettings.AddCharacterDisplay("Walker Turret", "Neck", new Vector3(0F, 0.3935F, 0.265F), new Vector3(355F, 0F, 0F), new Vector3(0.3F, 0.3F, 0.3F));
            ...
            displaySettings.AddCharacterDisplay("Technician", "Pelvis", new Vector3(0.12825F, 0.014F, -0.19375F), new Vector3(0F, 160F, 0F), new Vector3(0.075F, 0.075F, 0.075F));
            displaySettings.AddCharacterDisplay("Operator", "LowerAntennaTip", new Vector3(0.096F, -0.0375F, 0F), new Vector3(80F, 270F, 0F), new Vector3(0.1F, 0.1F, 0.1F));
            displaySettings.AddCharacterDisplay("Drifter", "BagPocketL", new Vector3(-0.0875F, -0.175F, 0F), new Vector3(45F, 283.75F, 280F), new Vector3(0.125F, 0.125F, 0.125F));
        }
