...
namespace Faithful
{
    internal class VengefulToaster
    {
        ...
        public VengefulToaster(Toolbox _toolbox)
        {
            ...
            //vengefulToasterItem = toolbox.items.AddItem("VENGEFUL_TOASTER", [ItemTag.Damage, ItemTag.AIBlacklist], "textemporalcubeicon", "temporalcubemesh", ItemTier.Tier2, _displaySettings: displaySettings);
