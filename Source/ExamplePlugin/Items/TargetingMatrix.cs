...
namespace Faithful
{
    internal class TargetingMatrix : ItemBase
    {
        ...
        Setting<bool> targetEffectGlobalSetting;
        ...
        private void CreateDisplaySettings(string _displayMeshName)
        {
            ...
            displaySettings.AddCharacterDisplay("Turret", "Head", new Vector3(-0.025F, 0.575F, -0.373F), new Vector3(0F, 0F, 0F), new Vector3(0.25F, 0.25F, 0.25F));
            displaySettings.AddCharacterDisplay("Walker Turret", "Head", new Vector3(-0.044F, 0.775F, 0.575F), new Vector3(0F, 0F, 0F), new Vector3(0.5F, 0.5F, 0.5F));
        ...
        public override void FetchSettings()
        {
            ...
            targetEffectGlobal = targetEffectGlobalSetting.Value;
