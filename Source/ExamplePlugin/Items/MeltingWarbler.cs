...
namespace Faithful
{
    internal class MeltingWarbler : ItemBase
    {
        ...
        private void CreateDisplaySettings(string _displayMeshName)
        {
            ...
            displaySettings.AddCharacterDisplay("Turret", "Head", new Vector3(0F, 0.85F, -0.7525F), new Vector3(0F, 0F, 0F), new Vector3(0.125F, 0.125F, 0.125F), "EngiTurretBody");
            displaySettings.AddCharacterDisplay("Turret", "Head", new Vector3(0F, 1.3965F, 0.80775F), new Vector3(0F, 0F, 0F), new Vector3(0.125F, 0.125F, 0.125F), "EngiWalkerTurretBody");
