...
namespace Faithful
{
    internal class CauterizingGreave : ItemBase
    {
        ...
        public CauterizingGreave(Toolbox _toolbox) : base(_toolbox)
        {
            ...
            cauterizingGreaveItem = Items.AddItem("CAUTERIZING_GREAVE", "Cauterizing Greave", [ItemTag.Utility], "texcauterizinggreaveicon", "cauterizinggreavemesh", ItemTier.Lunar, _displaySettings: displaySettings, _modifyItemModelPrefabCallback: ModifyModelPrefab, _modifyItemDisplayPrefabCallback: ModifyModelPrefab);
        ...
        private void CreateDisplaySettings(string _displayMeshName)
        {
            ...
            displaySettings.AddCharacterDisplay("Walker Turret", "Neck", new Vector3(0F, 0.295F, 0F), new Vector3(0F, 180F, 0F), new Vector3(0.5F, 0.25F, 0.5F));
            ...
            displaySettings.AddCharacterDisplay("Technician", "Shin.R", new Vector3(0F, 0.1225F, -0.00725F), new Vector3(0F, 180F, 0F), new Vector3(0.2F, 0.125F, 0.2F));
            displaySettings.AddCharacterDisplay("Operator", "CalfR", new Vector3(0.156F, 0.01F, -0.12F), new Vector3(0F, 187F, 94F), new Vector3(0.125F, 0.06F, 0.125F));
            displaySettings.AddCharacterDisplay("Drifter", "CalfR", new Vector3(-0.21F, -0.03F, -0.015F), new Vector3(0F, 0F, 90F), new Vector3(0.225F, 0.075F, 0.225F));
        }
